	...
	return (
		<main className="">
			{isLoading ? (
				...
				<main>
					<Link to="/blogs" className="myButton">
						Back
					</Link>
					<br />
					<main className="mr-80 ml-80">
						...
						<main className="">
							<img
								className="h-96 w-screen opacity-85"
								src={newImg}
							/>
						</main>
						<br />
						<main className="border-r-4 border-l-4">
							<main className="flex justify-center items-center text-xl mr-5 ml-5">
								<p className="text-justify">
									...
									the like). Where does it come from? Contrary
